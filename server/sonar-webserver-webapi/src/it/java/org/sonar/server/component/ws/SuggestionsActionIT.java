...
public class SuggestionsActionIT {
  private static final String[] SUGGESTION_QUALIFIERS =
      Stream.of(SuggestionCategory.values())
  ...
  @Rule public final UserSessionRule userSessionRule = UserSessionRule.standalone();
  ...
  private final EntityDefinitionIndexer entityDefinitionIndexer =
      new EntityDefinitionIndexer(db.getDbClient(), es.client());
  private final FavoriteFinder favoriteFinder = mock(FavoriteFinder.class);
  private final ComponentIndex index =
      new ComponentIndex(
          es.client(), new WebAuthorizationTypeSupport(userSessionRule), System2.INSTANCE);
  private final SuggestionsAction underTest =
      new SuggestionsAction(
          db.getDbClient(), index, favoriteFinder, userSessionRule, resourceTypes);
  private final PermissionIndexerTester authorizationIndexerTester =
      new PermissionIndexerTester(es, entityDefinitionIndexer);
  ...
  public void define_suggestions_action() {
    ...
    assertThat(action.params())
        ...
        .containsExactlyInAnyOrder(PARAM_MORE, PARAM_QUERY, PARAM_RECENTLY_BROWSED);
    assertThat(action.changelog())
        ...
        .containsExactlyInAnyOrder(
            ...
            tuple(
                "8.4",
                "The use of 'DIR', 'FIL','UTS' as values for parameter 'more' is no longer"
                    + " supported"),
  ...
  public void test_example_json_response() {
    ProjectDto project1 =
        db.components()
            .insertPublicProject(
                p -> p.setKey("org.sonarsource:sonarqube").setName("SonarSource :: SonarQube"))
            .getProjectDto();
    ProjectDto project2 =
        db.components()
            .insertPublicProject(
                p -> p.setKey("org.sonarsource:sonarlint").setName("SonarSource :: SonarLint"))
            .getProjectDto();
    entityDefinitionIndexer.indexAll();
    authorizationIndexerTester.allowOnlyAnyone(project1);
    authorizationIndexerTester.allowOnlyAnyone(project2);

    TestResponse wsResponse =
        ws.newRequest()
  ...
  public void suggestions_without_query_should_contain_recently_browsed() {
    ...
    SuggestionsWsResponse response =
        ws.newRequest()
            .setMethod("POST")
  ...
  public void suggestions_without_query_should_contain_favorites() {
    ...
    SuggestionsWsResponse response =
        ws.newRequest().setMethod("POST").executeProtobuf(SuggestionsWsResponse.class);
  ...
  @Test
  public void
      suggestions_without_query_should_not_contain_matches_that_are_neither_favorites_nor_recently_browsed() {
    ProjectDto project = db.components().insertPrivateProject().getProjectDto();
  ...
  public void suggestions_without_query_should_order_results() {
    ProjectDto project1 =
        db.components().insertPrivateProject(p -> p.setName("Alpha")).getProjectDto();
    ProjectDto project2 =
        db.components().insertPrivateProject(p -> p.setName("Bravo")).getProjectDto();
    ProjectDto project3 =
        db.components().insertPrivateProject(p -> p.setName("Charlie")).getProjectDto();
    ProjectDto project4 =
        db.components().insertPrivateProject(p -> p.setName("Delta")).getProjectDto();
    ...
    SuggestionsWsResponse response =
        ws.newRequest()
            ...
            .setParam(
                ...
                Stream.of(project3, project1).map(ProjectDto::getKey).collect(joining(",")))
            .executeProtobuf(SuggestionsWsResponse.class);
    ...
    assertThat(response.getResultsList())
        .flatExtracting(Category::getItemsList)
        .extracting(
            Suggestion::getName, Suggestion::getIsFavorite, Suggestion::getIsRecentlyBrowsed)
        .containsExactly(
  ...
  public void suggestions_without_query_should_return_empty_qualifiers() {
    ...
    assertThat(response.getResultsList())
        ...
        .containsExactlyInAnyOrder(
            tuple("VW", 0), tuple("APP", 0), tuple("SVW", 0), tuple("TRK", 1))
  ...
  public void suggestions_should_filter_allowed_qualifiers() {
    ...
    assertThat(response.getResultsList())
        ...
        .doesNotContain(FILE, UNIT_TEST_FILE);
  }
  ...
  public void should_not_return_suggestion_on_non_existing_project() {
    ...
    db.getDbClient()
        .purgeDao()
        .deleteProject(
            db.getSession(), project.getUuid(), PROJECT, project.getName(), project.getKey());
    db.commit();
  ...
  public void must_not_search_if_no_valid_tokens_are_provided() {
    ProjectDto project =
        db.components().insertPrivateProject(p -> p.setName("SonarQube")).getProjectDto();
  ...
  public void should_contain_component_names() {
    ...
    assertThat(response.getResultsList())
        ...
        .containsExactlyInAnyOrder(
            tuple(project1.getProjectDto().getKey(), project1.getProjectDto().getName()));
  }
  ...
  public void should_mark_recently_browsed_items() {
    ...
    SuggestionsWsResponse response =
        ws.newRequest()
            ...
            .setParam(
                PARAM_RECENTLY_BROWSED,
                Stream.of(file1.getKey(), project.getKey()).collect(joining(",")))
            .executeProtobuf(SuggestionsWsResponse.class);
  ...
  public void should_mark_favorite_items() {
    ...
    ProjectData nonFavouriteProject =
        db.components().insertPublicProject(p -> p.setName("Project2"));
    ...
    authorizationIndexerTester.allowOnlyAnyone(
        favouriteProject.getProjectDto(), nonFavouriteProject.getProjectDto());
    ...
    assertThat(response.getResultsList())
        ...
        .extracting(Suggestion::getKey, Suggestion::getIsFavorite)
        .containsExactly(
            tuple(favouriteProject.getProjectDto().getKey(), true),
            tuple(nonFavouriteProject.getProjectDto().getKey(), false));
  }
  ...
  public void should_return_empty_qualifiers() {
    ...
    assertThat(response.getResultsList())
        .extracting(Category::getQ, Category::getItemsCount)
        .containsExactlyInAnyOrder(
            tuple("VW", 0), tuple("SVW", 0), tuple("APP", 0), tuple("TRK", 1));
  }
  ...
  public void should_only_provide_project_for_certain_qualifiers() {
    ...
    ComponentDto dir =
        db.components()
            .insertComponent(ComponentTesting.newDirectory(project, "path").setName(query));
    ComponentDto file =
        db.components().insertComponent(ComponentTesting.newFileDto(project, dir).setName(query));
    ComponentDto test =
        db.components()
            .insertComponent(
                ComponentTesting.newFileDto(project, dir)
                    .setName(query)
    ...
    assertThat(response.getResultsList())
        .extracting(
            Category::getQ,
            c -> c.getItemsList().stream().map(Suggestion::hasProject).findFirst().orElse(null))
        .containsExactlyInAnyOrder(
  ...
  @Test
  public void
      should_not_propose_to_show_more_results_if_0_projects_are_found_and_no_search_query_is_provided() {
  ...
  @Test
  public void
      should_not_propose_to_show_more_results_if_5_projects_are_found_and_no_search_query_is_provided() {
  ...
  @Test
  public void
      should_not_propose_to_show_more_results_if_6_projects_are_found_and_no_search_query_is_provided() {
  ...
  @Test
  public void
      should_propose_to_show_more_results_if_7_projects_are_found_and_no_search_query_is_provided() {
  ...
  @Test
  public void
      show_more_results_if_requested_and_5_projects_are_found_and_no_search_query_is_provided() {
  ...
  @Test
  public void
      show_more_results_if_requested_and_6_projects_are_found_and_no_search_query_is_provided() {
  ...
  @Test
  public void
      show_more_results_if_requested_and_7_projects_are_found_and_no_search_query_is_provided() {
  ...
  @Test
  public void
      show_more_results_if_requested_and_26_projects_are_found_and_no_search_query_is_provided() {
  ...
  @Test
  public void
      show_more_results_if_requested_and_27_projects_are_found_and_no_search_query_is_provided() {
  ...
  private void check_proposal_to_show_more_results(
      int numberOfProjects,
      int expectedNumberOfResults,
      long expectedNumberOfMoreResults,
      @Nullable SuggestionCategory more,
      boolean useQuery) {
    String namePrefix = "MyProject";

    List<ProjectDto> projects =
        range(0, numberOfProjects)
            .mapToObj(
                i ->
                    db.components()
                        .insertPublicProject(p -> p.setName(namePrefix + i))
                        .getProjectDto())
            .toList();
