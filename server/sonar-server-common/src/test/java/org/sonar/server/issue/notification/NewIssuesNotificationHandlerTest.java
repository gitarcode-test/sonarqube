...
public class NewIssuesNotificationHandlerTest {
  ...
  private NewIssuesNotificationHandler underTest =
      new NewIssuesNotificationHandler(notificationManager, emailNotificationChannel);
  ...
  public void deliver_has_no_effect_if_emailNotificationChannel_is_disabled() {
    ...
    Set<NewIssuesNotification> notifications =
  ...
  @Test
  public void
      deliver_has_no_effect_if_no_notification_has_subscribed_recipients_to_NewIssue_notifications() {
    ...
    when(notificationManager.findSubscribedEmailRecipients(
            NEW_ISSUES_DISPATCHER_KEY, projectKey, ALL_MUST_HAVE_ROLE_USER))
        .thenReturn(emptySet());
  ...
  public void deliver_ignores_notification_without_projectKey() {
    ...
    Set<NewIssuesNotification> withProjectKey =
        IntStream.range(0, 1 + new Random().nextInt(5))
            .mapToObj(i -> newNotification(projectKey))
            .collect(toSet());
    Set<NewIssuesNotification> noProjectKey =
        IntStream.range(0, 1 + new Random().nextInt(5))
            .mapToObj(i -> newNotification(null))
            .collect(toSet());
  ...
  @Test
  public void
      deliver_checks_by_projectKey_if_notifications_have_subscribed_assignee_to_NewIssue_notifications() {
    ...
    Set<EmailRecipient> emailRecipients2 =
        IntStream.range(0, 1 + new Random().nextInt(10))
            ...
            .collect(toSet());
    when(notificationManager.findSubscribedEmailRecipients(
            NEW_ISSUES_DISPATCHER_KEY, projectKey1, ALL_MUST_HAVE_ROLE_USER))
        .thenReturn(emailRecipients1);
    when(notificationManager.findSubscribedEmailRecipients(
            NEW_ISSUES_DISPATCHER_KEY, projectKey2, ALL_MUST_HAVE_ROLE_USER))
