...
public class BitbucketServerProjectCreator implements DevOpsProjectCreator {
  ...
  public BitbucketServerProjectCreator(
  ...
  @Override
  public ComponentCreationData createProjectAndBindToDevOpsPlatform(
      DbSession dbSession,
    ...
    Repository repository =
        bitbucketServerRestClient.getRepo(url, pat, bitbucketProject, bitbucketRepo);
        ...
        .orElseGet(
            () ->
                projectKeyGenerator.generateUniqueProjectKey(
                    repo.getProject().getKey(), repo.getSlug()));
  }
  ...
  private void createProjectAlmSettingDto(
      DbSession dbSession,
      Repository repository,
